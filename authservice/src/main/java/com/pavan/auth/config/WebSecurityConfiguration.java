...
import com.pavan.auth.filter.JwtAutheticationFilter;
...
public class WebSecurityConfiguration {
    ...
    public WebSecurityConfiguration(@Lazy UserDetailsService userDetailsService, JwtAutheticationFilter jwtAuthenticationFilter) {
